...
class InkyWHAT:
    """Fallback faux Display Driver for testing InkyWHAT"""
    ...
    def set_image(self, image):
        """Converts the provided image to palette mode before setting it as the active image"""
        # TODO: adjust palette colors based on self.colour
